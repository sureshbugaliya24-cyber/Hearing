<?php 
$page_title = "Best Hearing Aids in Sri Ganganagar | Hearing Healthcare Clinic";
$meta_description = "Leading hearing aid specialist in Sri Ganganagar. Expert audiology services and digital hearing aids in Sri Ganganagar, Rajasthan.";
...
<section class="relative py-20 md:py-28 bg-[#00a8d6] text-center text-white overflow-hidden">
    <div class="container mx-auto px-6 relative z-10">
        ...
        <p class="text-lg md:text-xl opacity-90 max-w-3xl mx-auto font-medium leading-relaxed">
            Expert hearing care services in Sri Ganganagar
        </p>
    </div>
</section>
            ...
            <div class="lg:w-5/12 space-y-4">
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500">+91-9549923321</p>
                    </div>
                </div>
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500">Shopping Complex, 120-121, Sukhadia Cir, opposite Choudhary Ultrasound, Vrindavan colony, 335001</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4 text-center">
        <h2 class="text-3xl font-[800] text-[#121926] mb-2">Visit Our Sri Ganganagar Clinic</h2>
        <p class="text-gray-500 mb-10">Find us on Google Maps</p>
        <div class="rounded-[30px] overflow-hidden shadow-xl border-8 border-gray-50 h-[450px]">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3458.097970318538!2d73.87903039999999!3d29.919081600000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3917b5fb460fd2b3%3A0xdee888512249fb6c!2sHearing%20Healthcare%20Clinic%20Sri%20Ganganagar!5e0!3m2!1sen!2sin!4v1772709898005!5m2!1sen!2sin" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 max-w-6xl mx-auto">
            ...
            foreach($cities as $city) {
                $active = ($city == "Sri Ganganagar") ? "bg-[#00a8d6] text-white" : "bg-white text-[#121926] hover:bg-[#f0faff]";
                ...
                echo '<a href="hearing-aid-in-'.$url_city.'.php" class="'.$active.' p-4 rounded-xl shadow-sm border border-gray-100 flex items-center gap-3 transition-all">
                        <i class="fas fa-map-marker-alt '.($city == "Sri Ganganagar" ? "text-white" : "text-[#00a8d6]").'"></i>
